function radialBarChart(options) {
  ...
  controlContainer.html(`
    <div class="w-100 d-flex justify-content-end">
      ...
      <div class="form-group pr-3">
        <label>Select Date Range for Average</label>
      ...
      <div class="form-group day-select">
        <label>Filter Day for Average</label>
  ...
  function updateControlAlignment() {
    controlContainer
      .select(".day-select")
      .style("padding-right", containerWidth - width / 2 - outerRadius + "px");
  }
  ...
  gAxisLabels
    ...
    .attr("transform", d => {
      const angle =
        ...
        Math.PI / 2 -
        (angleScale.step() * angleScalePadding) / 2;
      return `rotate(${(angle * 180) / Math.PI + 90}, ${axisLabelRadius *
        Math.cos(angle)}, ${axisLabelRadius * Math.sin(angle)})`;
    })
  ...
  ////////////////////////////////////////////////////////////
  chart.updateDayBars = function(date) {
